...
p(86,3)=p(86,3)+p(86,1)*0.65;
p(86,1)=p(86,1)*0.35;
beta = 0.1109;
gamma = 0.0559;
T2 = 146;
[~,p2]=ode45(@(t,p) sir_fun(t,p,beta,gamma), [86:1:T2],[p(86,1) p(86,2) p(86,3)]);
plot(86:T2,p2(:,2),'b-')
...
function f = sir_Obj_fun(x)
    ...
    beta = x(1);
    gamma = x(2);
    [~,p]=ode45(@(t,p) sir_fun(t,p,beta,gamma), [1:1:62],[true_s(1) true_i(1) true_r(1)]);
